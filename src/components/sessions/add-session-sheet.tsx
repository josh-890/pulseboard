...
export function AddSessionSheet({ labels, projects }: AddSessionSheetProps) {
  const router = useRouter();
  const [open, setOpen] = useState(false);

  const form = useForm<CreateSessionFormValues, unknown, CreateSessionInput>({
  ...
  async function onSubmit(values: CreateSessionInput) {
    ...
    toast.error(typeof result.error === "string" ? result.error : "Failed to create session");
  }
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="flex w-full flex-col sm:max-w-lg">
        <SheetHeader className="border-b pb-4 px-4">
          <SheetTitle className="text-lg font-semibold">Add Session</SheetTitle>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g. Studio A, Los Angeles" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea placeholder="Session description" rows={3} {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
