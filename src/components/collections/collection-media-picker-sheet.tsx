...
export function CollectionMediaPickerPanel({
  ...
  function handleDragStart(e: React.DragEvent<HTMLButtonElement>, item: MediaSearchResult) {
    ...
    // Use the thumbnail image as drag preview
...
export function CollectionMediaPickerSheet({
  collectionId,
  open,
  onOpenChange,
}: CollectionMediaPickerSheetProps) {
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="flex w-full flex-col sm:max-w-2xl">
        <SheetHeader>
          ...
          <SheetDescription>
            Select existing media items to add to this collection.
          </SheetDescription>
        </SheetHeader>
